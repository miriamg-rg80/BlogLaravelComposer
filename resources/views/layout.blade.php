    ...
    <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('create-album') }}"> Create New Album</a>
                <a class="dropdown-item" href="{{ URL::to('all-album') }}"> All Albums </a>
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                ...
                <a class="dropdown-item" href="{{ URL::to('create-thing') }}"> Create Thing</a>
                <a class="dropdown-item" href="{{ URL::to('all-things') }}"> All Things </a>
